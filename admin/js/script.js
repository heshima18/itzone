...
let pages = new Array('home','add-product','view-products','orders','log','add-discount','add-user','users','categories','sub-categories','brands','series','availability','usability');
