				...
				parent.innerHTML+=`<div class="product w-250p h-360p bc-white br-5p ovh ml-10p mr-10p mb-15p mt-15p iblock b-70-resp bml-7-resp bmr-6-resp b-1-s-gray">
						<div class="w-100 h-170p">
							<div class="image bsbb w-100 h-100 br-5p p-r">
								<span class="#icon wish-icon h-20p w-40p p-10p  center-2 w-a p-a">
								...
								<span class="verdana r-0 fs-14p bsbb p-a t-0 ${cc(d.conditions[0].name)} bc-gray p-7p center h-20p bblr-3p w-a capitalize" id="${0}">${d.conditions[0].name}
								</span>
