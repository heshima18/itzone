...
async function getparams(url) {
    ...
    if (id.id == null) {
        ...
        if (res.success) {
            document.title =  `${res.message[0].pname} | ITZONE +`
            ...
            res.message.forEach(pd => {
                ...
                tgscntnt.innerHTML = `  <li class="w-100 p-5p bsbb">
                                                ...
                                                <a class="td-none ls-n" href="${geturl()}/browse/?series=${pd.famname}"><span class="w-a h-a iblock mt-5p bc-tr-theme theme consolas fs-14p br-2p pl-6p pr-6p ml-5p bsbb nowrap">${pd.famname} </span></a>
...
function adsb(name,image,condition,price,element) {
    ...
    thec.innerHTML = `<div class="w-100 h-100">
                <ul class="ls-none bc-white p-0 m-0 bsbb br-5p w-200p  us-none">
						<li class=" bb-1-s-g m-0 w-100 titles hover-2 us-none ">
							...
							<ul class="ls-none bc-white w-100 p-r capitalize hidden bsbb pl-10p">
								<li class="pl-10p  hover pt-10p pb-10p bsbb linkSwitcher hover-2 us-none sfpro">post</li>
								<li class="pl-10p  hover pt-10p pb-10p bsbb linkSwitcher hover-2 us-none sfpro" title="all" id="orders">stories</li> 
							</ul>
						</li>
						<li class=" m-0 w-100 titles hover-2 us-none bb-1-s-g">
							...
							<ul class="ls-none bc-white w-100 p-r capitalize hidden bsbb pl-10p">
								<li class="pl-10p  hover pt-10p pb-10p bsbb linkSwitcher hover-2 us-none sfpro" id="add-user">stories</li>
								<li class="pl-10p  hover pt-10p pb-10p bsbb linkSwitcher hover-2 us-none sfpro" id="users">post</li>  
							</ul>
						</li>
						<li class="m-0 w-100 linkSwitcher hover-2 us-none titles hover-2 us-none">
							<div class="w-100 w-90 pt-15p pl-15p h-40p bsbb">
								<span><i class="fas fa-user theme"></i></span>
								<span class="fs-15p green helvetica">whatsapp</span>
							</div>
							<ul class="ls-none bc-white w-100 p-r capitalize hidden bsbb pl-10p">
								<li class="pl-10p  hover pt-10p pb-10p bsbb linkSwitcher hover-2 us-none sfpro new" id="new-queries" title="new">status</li>
								<li class="pl-10p  hover pt-10p pb-10p bsbb linkSwitcher hover-2 us-none sfpro all" title="all" id="queries">message</li>  
							</ul>
						</li>
					</ul>
    </div>`
